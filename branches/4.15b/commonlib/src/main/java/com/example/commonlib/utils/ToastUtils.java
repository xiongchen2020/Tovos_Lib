...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(CommonContext.getContext(), "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public static void showToast(String msg) {
        Toast.makeText(CommonContext.getContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void setResultToToastUtil(final String string) {
        Message msg = new Message();
        msg.what = MESSAGE_TOAST;
        msg.obj = string;
        mUIHandler.sendMessage(msg);
