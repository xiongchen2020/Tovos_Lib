...
public class SPUtils {
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = HubContext.getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
    ...
    public static Object get(String key, Object defaultObject) {
        SharedPreferences sp = HubContext.getContext().getSharedPreferences(FILE_NAME,
